...
print "Start minutes after midnight ", start_minutes_after_midnight

end_minutes_after_midnight = start_minutes_after_midnight + minutes_ran
print "End minutes after midnight ", end_minutes_after_midnight

end_time_hours = end_minutes_after_midnight / 60
end_time_minutes = end_minutes_after_midnight - (end_time_hours * 60)
print "End time hours ", end_time_hours
print "End time minutes ", end_time_minutes
